...
<div class="fade-in pt-2 space-y-5">
    ...
    <div class="rounded-2xl p-5 flex items-center gap-4 relative overflow-hidden" style="background:linear-gradient(135deg,#3b0764,#4c1d95,#5b21b6);border:1px solid #7c3aed">
        ...
        <div class="relative z-10">
            <p class="text-violet-200 text-xs font-semibold uppercase tracking-wider mb-0.5">Master Data</p>
            <p class="text-white font-bold text-lg">Tambah Pelanggan Baru</p>
            <p class="text-violet-300 text-xs mt-0.5">Isi Form Di Bawah Untuk Mendaftarkan Pelanggan</p>
        </div>
    </div>
    ...
    <div class="card">
        <div class="flex items-center gap-3 mb-6 pb-5 border-b border-slate-100">
            ...
            <div>
                ...
                <p class="text-slate-400 text-xs mt-0.5">Isi Semua Data Pelanggan Dengan Benar</p>
            </div>
        </div>
        ...
        <form action="{{ route('admin.customers.store') }}" method="POST" class="space-y-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" placeholder="Nama Lengkap Pelanggan" class="form-input pl-10" required>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" placeholder="email@contoh.com" class="form-input pl-10" required>
                    </div>
                </div>

                <div>
                    <label class="form-label">
                        <i class="fas fa-lock text-cyan-400 mr-1.5"></i> Password
                    </label>
                    <div class="relative">
                        <i class="fas fa-lock absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-400 text-sm"></i>
                        <input type="password" name="password" id="passwordInput" placeholder="Minimal 6 Karakter" class="form-input pl-10 pr-12" required>
                    ...
                    <p class="text-xs text-slate-400 mt-1.5 flex items-center gap-1">
                        ...
                        Password Akan Digunakan Pelanggan Untuk Login Di Aplikasi Mobile
                    </p>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="phone" value="{{ old('phone') }}" placeholder="08xxxxxxxxxx" class="form-input pl-10" required>
                    </div>
                    <p class="text-xs text-slate-400 mt-1.5 flex items-center gap-1">
                        <i class="fas fa-info-circle text-blue-300"></i>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <textarea name="address" rows="3" placeholder="Jl. Contoh No. 1, Kelurahan, Kecamatan, Kota" class="form-input pl-10 resize-none" required>{{ old('address') }}</textarea>
                </div>
                <p class="text-xs text-slate-400 mt-1.5 flex items-center gap-1">
                    <i class="fas fa-info-circle text-blue-300"></i>
